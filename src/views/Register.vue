<template>
  <div
    class="min-h-auto w-full flex items-center justify-center bg-white relative px-4 py-10 sm:px-6 lg:px-8"
  >
    ...
    >
      ...
      <div class="flex flex-col justify-center items-center w-full px-6 sm:px-10 lg:px-14 py-12">
        <div class="w-full">
          ...
          <form @submit.prevent="handleRegistration">
            ...
            <div class="mb-5">
              ...
              <p v-if="passwordsMismatch" class="text-red-700 text-sm mt-1 font-medium">
            ...
            <button
              type="submit"
              class="w-full py-4 bg-[#009200] text-white rounded-[10px] text-lg font-bold cursor-pointer transition shadow-md hover:bg-[#007a00] hover:-translate-y-[1px] disabled:bg-gray-300 disabled:cursor-not-allowed mt-2 mb-5"
              :disabled="isLoading"
            >
          ...
          <div class="flex items-center text-center my-4 text-xs text-gray-500 font-semibold">
            <hr class="flex-grow border-t border-gray-300" />
            <span class="px-4">Or Continue With</span>
            <hr class="flex-grow border-t border-gray-300" />
          </div>

          <div class="flex justify-center gap-4 sm:gap-5 mb-6 flex-wrap">
            <button
              type="button"
