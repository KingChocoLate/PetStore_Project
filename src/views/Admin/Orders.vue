      ...
      <section class="relative overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm transition-all hover:shadow-md">
        ...
        <div class="relative p-6 sm:p-8">
          ...
          <div class="mt-8 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:flex lg:overflow-x-auto lg:gap-4 lg:pb-4 xl:grid xl:grid-cols-6 xl:pb-0">
            ...
            <div class="min-w-[140px] rounded-2xl border border-emerald-100 bg-emerald-50/50 p-4 shadow-sm cursor-pointer hover:bg-emerald-50 transition flex-1" @click="activePaymentFilter = 'paid'; page = 1">
            ...
            <div class="min-w-[140px] rounded-2xl border border-amber-100 bg-amber-50/50 p-4 shadow-sm cursor-pointer hover:bg-amber-50 transition flex-1" @click="activePaymentFilter = 'unpaid'; page = 1">
          ...
          <div class="p-2 flex flex-col xl:flex-row xl:items-center xl:justify-between gap-4">
            ...
            <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
              ...
              <div class="relative w-full sm:w-64 group">
                ...
                <input v-model.trim="q" type="text" placeholder="Search ID or Customer..."
